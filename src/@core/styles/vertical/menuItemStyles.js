...
const menuItemStyles = (verticalNavOptions, theme, settings) => {
  ...
  return {
    ...
    rgba(17, 129, 123, 0.7) 0%, /* Teal Green with 70% opacity */
    #11817B 100%) !important` /* Solid Teal Green */
                  : `linear-gradient(270deg,
    #031B1A 0%, /* Solid Dark Greenish-Black */
    rgba(3, 27, 26, 0.7) 100%) !important` /* Dark Greenish-Black with 70% opacity */,
