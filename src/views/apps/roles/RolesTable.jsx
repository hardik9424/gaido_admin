...
import { editRoles, getAllPermissions, getAllRoles } from '@/app/api'
      ...
      },
      {
        ...
        cell: ({ row }) => (
          ...
          >
            ...
            <IconButton aria-label='delete' onClick={() => console.log('Delete clicked for:', row.original)}>
